    ...
    <main className="min-h-screen bg-[#f6f8fc] py-5 dark:bg-slate-950">
      <div className="mx-auto max-w-[1500px] px-3 sm:px-5 lg:px-6">
        ...
        <div className="mb-3 flex items-center justify-between gap-3 lg:hidden">
          ...
          <div className="flex rounded-xl border border-slate-200 bg-white p-1 dark:border-slate-800 dark:bg-slate-900"><button type="button" onClick={() => setMobileMap(false)} className={`flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-xs font-bold ${!mobileMap ? "bg-blue-50 text-blue-600" : "text-slate-500"}`}><List className="h-4 w-4" />List</button><button type="button" onClick={() => setMobileMap(true)} className={`flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-xs font-bold ${mobileMap ? "bg-blue-50 text-blue-600" : "text-slate-500"}`}><Map className="h-4 w-4" />Map</button></div>
        </div>
